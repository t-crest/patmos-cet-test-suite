// RUN: %multi-file-test h264_dec_main false
// END.
/*
...
void h264_dec_init (int);
int h264_dec_return ();
void h264_dec_decode_one_macroblock( struct h264_dec_img_par *img );
void h264_dec_main( void ) __attribute__((noinline));
int main( void );
