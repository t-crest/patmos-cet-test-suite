// RUN: %multi-file-test gsm_dec_main false
// END.
/*
...
gsm gsm_dec_create( int );
void gsm_dec_init( int );
...
void gsm_dec_init( int seed )
{
  gsm_dec_state_ptr = gsm_dec_create(seed);
}
