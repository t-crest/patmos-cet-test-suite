// RUN: %single-file-test statemate_main false
// END.
/*
...
void statemate_init( int seed )
{
  statemate_tm_entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRLch_BLOCK_ERKENNUNG_CTRL__N_copy
    = random_or(seed, 0);
  statemate_tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRLexited_BEREIT_FH_TUERMODUL_CTRL
    = random_or(seed, 0);
  statemate_tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL = random_or(seed, 0);
  statemate_NICHT_INITIALISIERT_NICHT_INITIALISIERT_next_state = random_or(seed, 0);
  statemate_ZENTRAL_KINDERSICHERUNG_CTRL_next_state = random_or(seed, 0);
  statemate_MEC_KINDERSICHERUNG_CTRL_next_state = random_or(seed, 0);
  statemate_KINDERSICHERUNG_CTRL_KINDERSICHERUNG_CTRL_next_state = random_or(seed, 0);
  statemate_B_FH_TUERMODUL_CTRL_next_state = random_or(seed, 0);
  statemate_A_FH_TUERMODUL_CTRL_next_state = random_or(seed, 0);
  statemate_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL_next_state = random_or(seed, 0);
  statemate_INITIALISIERT_FH_TUERMODUL_CTRL_next_state = random_or(seed, 0);
  statemate_TIPP_SCHLIESSEN_FH_TUERMODUL_CTRL_next_state = random_or(seed, 0);
  statemate_MANUELL_SCHLIESSEN_FH_TUERMODUL_CTRL_next_state = random_or(seed, 0);
  statemate_OEFFNEN_FH_TUERMODUL_CTRL_next_state = random_or(seed, 0);
  statemate_SCHLIESSEN_FH_TUERMODUL_CTRL_next_state = random_or(seed, 0);
  statemate_FH_STEUERUNG_DUMMY_FH_STEUERUNG_DUMMY_next_state = random_or(seed, 0);
  statemate_EINKLEMMSCHUTZ_CTRL_EINKLEMMSCHUTZ_CTRL_next_state = random_or(seed, 0);
  statemate_BEWEGUNG_BLOCK_ERKENNUNG_CTRL_next_state = random_or(seed, 0);
  statemate_BLOCK_ERKENNUNG_CTRL_BLOCK_ERKENNUNG_CTRL_next_state = random_or(seed, 0);
