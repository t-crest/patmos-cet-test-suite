// RUN: %single-file-test countnegative_main false
// END.
/*
...
*/
void countnegative_initSeed( int );
...
*/
void countnegative_initSeed ( int seed )
{
  countnegative_seed = seed;
}
